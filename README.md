                ...
                <b:if cond='data:view.isLayoutMode or data:widgets any (w =&gt; w.sectionId == &quot;search_top&quot;)'>
                  <div class='search'>
                    ...
                    <b:section id='search_top' name='Search (Top)' showaddelement='false'>
                      <b:widget id='BlogSearch1' locked='true' title='Cari Blog Ini' type='BlogSearch' visible='true'>
                        <b:includable id='main'>
          ...
          <input class='search-action flat-button' expr:value='data:messages.search.escaped' type='submit'/>
                ...
                <div class='blog-name container'>
                  <b:section class='container' id='header' name='Header' showaddelement='false'>
                    <b:widget id='Header1' locked='true' title='ayuni nuralya (Header)' type='Header' visible='true'>
                      <b:widget-settings>
                  ...
                  <nav role='navigation'>
                    <b:section class='clearboth' id='page_list_top' name='Page List (Top)' showaddelement='false'>
                      <b:widget cond='!data:view.isPost' id='PageList1' locked='true' title='' type='PageList' visible='false'>
                        <b:widget-settings>
                          <b:widget-setting name='pageListJson'><![CDATA[{'home': {'href': 'http://ayuninuralya.blogspot.com/', 'title': 'Beranda', 'position': 0}}]]></b:widget-setting>
    ...
    <aside class='sidebar-container container sidebar-invisible' role='complementary'>
      ...
      <div class='sidebar_top_wrapper'>
        ...
        <b:section class='sidebar_top' id='sidebar_top' name='Sidebar (Top)'>
          <b:widget id='Profile1' locked='true' title='Mengenai Saya' type='Profile' visible='true'>
            <b:widget-settings>
